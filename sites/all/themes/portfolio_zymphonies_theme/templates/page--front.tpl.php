...
<!-- change this also
 --><div class="clearfix float_my_childern">
      ...
      <?php endif; ?>
<!--  chge the id as site-title_new from site-title
 -->  <?php
      // $elango = "I am elango started web development as a passion but later covert into full time professional >> ReadMe";

        $elango =                      "(っ◔◡◔)っ ♥                    
                                             I 
                                       am Navina 
                 started web development as a passion 
                but later convert into full time professional 
                                      >> Read 
                                             ♥  ˜”*°•.˜”*°•";
      ?>
      
      <div id="site-title_new">
<!--         <div class ="square-content">
 -->        
          <a href="/node/2" title="<?php print t('Home'); ?>"><?php print $elango; ?></a> 

<!--         <a ><?php print $elango; ?></a>
 --><!--         <div id="site-description"><?php print $site_name; ?></div>
  -->   <!-- </div>
 -->      </div>
    </div> 
  </header>
  ...
  <div id="scroll_down">
    <?php $Scroll_down_path = path_to_theme() . '/images/custom/scrollDown.png'; ?>
    <img src="<?php print $Scroll_down_path ?>" />
  </div>

<!--     <div id="scroll_down_second">
    <?php $Scroll_down_path = path_to_theme() . '/images/custom/scrollDown.png'; ?>
    <img src="<?php print $Scroll_down_path ?>" />
  </div> -->
...
<div class="front-blocks">
  ...
  <?php endif; ?>
    ...
    <?php
        $my_static_banner = path_to_theme() . '/images/custom/process.png';
    ?>
 ...
 <!-- code to hide the company name in the front page  -->
